...
const createSchema = knex => knex.schema
  ...
  .createTable( 'lines', table => {
    ...
    table.text( 'gurmukhi' ).notNullable() // To be deprecated - currently represents SGPC
  ...
  .createTable( 'line_content', table => {
    ...
    table.integer( 'publication_id' ).references( 'id' ).inTable( 'publications' ).notNullable()
    table.text( 'gurmukhi' ).notNullable()
    table.primary( [ 'line_id', 'publication_id' ] )
  } )
  ...
  .createTable( 'transliterations', table => {
    ...
    table.primary( [ 'line_id', 'language_id' ] )
  } )
