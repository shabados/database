...
NOTE: If we have missed any attribution, copyrights, or crediting, please link:https://github.com/ShabadOS/{repo}/issues/new[let us know] or fork this repo and submit a link:CONTRIBUTING.adoc[pull request].

Though unmentioned in the bibliography of sources below, the following are credited for their work in pioneering the digitization process of gurbani, translations, and pronunciations:
